...
var myArray = sum(sum(testArray[0], testArray[1])[0], testArray[2])[0];
var message = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + myArray + ' is their sum.'
...
var myArray = multiply(multiply(testArray[0], testArray[1])[0], testArray[2])[0];
var message = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + myArray + '.'
return [myArray, message]
}
